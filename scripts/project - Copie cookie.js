...
function saveCart(achats,) {
    setCookie('achats', achats, 5);
...
// function creerCookie(nom,achats,jour){
...
// }
// // si les jours ont pas été définis, pas besoin de calcul;
// else {
//     var exp ="";
// }
// document.cookie = nom+"="+achats+exp+";path=/";

// function lireCookie(nom){
//     //on récupère le nom et le signe"="
//     var nomEtEgal = nom + "=";
//     // récupère les cookies dans un tableau
...
// return c.substring(nomEtEgal.lenght, c.length);
//         }
//     }
...
//     //on donne le nom du cookie à supprimer, puis on utilise la fonction creerCookie() pour indiquer une date d'expiration passée.
//     creerCookie(nom,"",-1);
// }
